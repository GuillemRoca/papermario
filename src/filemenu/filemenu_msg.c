...
u8 filemenu_msg_CA_es[] = {0x26, 0x29, 0xFD};  // FI (Catalan)
#else
...
u8 filemenu_msg_01_es[] = {0x34, 0x52, 0x49, 0x41, 0xF7, 0x46, 0x49, 0x54, 0x58, 0x45, 0x52, 0x1A, 0xFD};  // Tria fitxer: (Catalan)
...
u8 filemenu_msg_02_es[] = {0x34, 0x52, 0x49, 0x41, 0xF7, 0x45, 0x4C, 0xF7, 0x46, 0x49, 0x54, 0x58, 0x45, 0x52, 0xF7, 0x41, 0xF7, 0x45, 0x53, 0x42, 0x4F, 0x52, 0x52, 0x41, 0x52, 0x1A, 0xFD};  // Tria el fitxer a esborrar: (Catalan)
...
u8 filemenu_msg_04_es[] = {0x8E, 0x31, 0x55, 0x49, 0x4E, 0xF7, 0x46, 0x49, 0x54, 0x58, 0x45, 0x52, 0xF7, 0x43, 0x4F, 0x50, 0x49, 0x45, 0x53, 0x1F, 0xFD};  // ¿Quin fitxer copies? (Catalan)
...
u8 filemenu_msg_05_es[] = {0x8E, 0x2F, 0x4E, 0xF7, 0x45, 0x4C, 0xF7, 0x43, 0x4F, 0x50, 0x49, 0x45, 0x53, 0x1F, 0xFD};  // ¿On el copies? (Catalan)
...
u8 filemenu_msg_06_es[] = {0x2E, 0x4F, 0x55, 0xFD};  // Nou (Catalan)

// Level
u8 filemenu_msg_07[] = {0x2C, 0x45, 0x56, 0x45, 0x4C, 0xFD};
u8 filemenu_msg_07_fr[] = {0x2E, 0x49, 0x56, 0x45, 0x41, 0x55, 0xFD};
u8 filemenu_msg_07_es[] = {0x2E, 0x49, 0x56, 0x45, 0x4C, 0x4C, 0xFD};  // Nivell (Catalan)
...
u8 filemenu_msg_08_es[] = {0x34, 0x45, 0x4D, 0x50, 0x53, 0xFD};  // Temps (Catalan)
...
u8 filemenu_msg_09_es[] = {0x25, 0x53, 0x42, 0x4F, 0x52, 0x52, 0x41, 0x52, 0xFD};  // Esborrar (Catalan)
...
u8 filemenu_msg_10_es[] = {0x33, 0x4F, 0x52, 0x54, 0x49, 0x52, 0xFD};  // Sortir (Catalan)
...
u8 filemenu_msg_11_es[] = {0x23, 0x4F, 0x50, 0x49, 0x41, 0x52, 0xFD};  // Copiar (Catalan)
...
u8 filemenu_msg_12_es[] = {0x30, 0x52, 0x49, 0x4D, 0x45, 0x52, 0x41, 0xF7, 0x36, 0x45, 0x47, 0x41, 0x44, 0x41, 0xFD};  // Primera Vegada (Catalan)
...
u8 filemenu_msg_16_es[] = {0x8E, 0x25, 0x53, 0x42, 0x4F, 0x52, 0x52, 0x4F, 0xF7, 0x45, 0x4C, 0xFD};  // ¿Esborro el (Catalan)
...
u8 filemenu_msg_19_es[] = {0x2E, 0x4F, 0x4D, 0xF7, 0x44, 0x45, 0x4C, 0xF7, 0x46, 0x49, 0x54, 0x58, 0x45, 0x52, 0xF7, 0x1A, 0xFD};  // Nom del fitxer : (Catalan)

// OK?
u8 filemenu_msg_21[] = {0x2F, 0x2B, 0x1F, 0xFD};
u8 filemenu_msg_21_es[] = {0x8E, 0x36, 0x41, 0x4C, 0x1F, 0xFD};  // ¿Val? (Catalan)
...
u8 filemenu_msg_22_es[] = {0x26, 0x49, 0x54, 0x58, 0x45, 0x52, 0xFD};  // Fitxer (Catalan)

// <DE> Dat. / <FR> Fich. / <ES/CA> Fitx.
u8 filemenu_msg_pal_20_de[] = {0x24, 0x41, 0x54, 0x0E, 0xFD};
u8 filemenu_msg_pal_20_fr_es[] = {0x26, 0x49, 0x43, 0x48, 0x0E, 0xFD};
u8 filemenu_msg_pal_20_ca[] = {0x26, 0x49, 0x54, 0x58, 0x0E, 0xFD};  // Fitx. (Catalan)
...
u8 filemenu_msg_23_es[] = {0x53, 0x45, 0x52, 0x78, 0xF7, 0x45, 0x53, 0x42, 0x4F, 0x52, 0x52, 0x41, 0x54, 0x0E, 0xFD};  // será esborrat. (Catalan)
...
u8 filemenu_msg_24_es[] = {0x8E, 0x36, 0x4F, 0x4C, 0x53, 0xF7, 0x43, 0x4F, 0x50, 0x49, 0x41, 0x52, 0x0D, 0x4C, 0x4F, 0xF7, 0x41, 0x51, 0x55, 0x81, 0xF7, 0x1F, 0xFD};  // ¿Vols copiar-lo aquí ? (Catalan)
...
u8 filemenu_msg_25_es[] = {0x8E, 0x36, 0x4F, 0x4C, 0x53, 0xF7, 0x41, 0x51, 0x55, 0x45, 0x53, 0x54, 0xF7, 0x46, 0x49, 0x54, 0x58, 0x45, 0x52, 0x1F, 0xFD};  // ¿Vols aquest fitxer? (Catalan)
...
u8 filemenu_msg_27_es[] = {0x48, 0x41, 0xF7, 0x45, 0x53, 0x54, 0x41, 0x54, 0xF7, 0x45, 0x53, 0x42, 0x4F, 0x52, 0x52, 0x41, 0x54, 0x0E, 0xFD};  // ha estat esborrat. (Catalan)

// <blank> / Le / El
u8 filemenu_msg_28[] = {0xFD};
u8 filemenu_msg_28_fr[] = {0x2C, 0x45, 0xFD};
u8 filemenu_msg_28_es[] = {0x25, 0x4C, 0xFD};  // El (Catalan)
...
u8 filemenu_msg_29_es[] = {0x23, 0x85, 0x50, 0x49, 0x41, 0xF7, 0x44, 0x45, 0x4C, 0xFD};  // Còpia del (Catalan)

// to
u8 filemenu_msg_30[] = {0x54, 0x4F, 0xFD};
u8 filemenu_msg_30_de[] = {0x4E, 0x41, 0x43, 0x48, 0xFD};
u8 filemenu_msg_30_fr[] = {0x41, 0x55, 0xFD};
u8 filemenu_msg_30_es[] = {0x41, 0x4C, 0xFD};  // al (Catalan)
...
u8 filemenu_msg_31_es[] = {0x48, 0x41, 0xF7, 0x45, 0x53, 0x54, 0x41, 0x54, 0xF7, 0x43, 0x52, 0x45, 0x41, 0x54, 0x0E, 0xFD};  // ha estat creat. (Catalan)
...
u8 filemenu_msg_32_es[] = {0x8D, 0x29, 0x4E, 0x54, 0x52, 0x4F, 0x44, 0x55, 0x45, 0x49, 0x58, 0xF7, 0x4E, 0x4F, 0x4D, 0x01, 0xFD};  // ¡Introdueix nom! (Catalan)
...
u8* gFileMenuMessages_es[] = {
    ...
    [FILE_MESSAGE_PAL_FILE_20]                 filemenu_msg_pal_20_ca,
